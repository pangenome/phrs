...
\abstract{
\textbf{Human subtelomeres have long been known to contain duplicated sequence
...
\cite{acrocentric_Altemose2022,Guarracino2023,acrocentric_rdna_robertsonian_deLima2025,acrocentric_Guarracino2025ape}; the D4Z4
...
PHR windows themselves ($B/W = 0.002$ versus $0.027$, a 13-fold difference),
...
The high-confidence patch table has a median tract length of 1,517 bp
(IQR 1,136--2,981 bp), whereas a lower-merge best-hit rerun resolved 37,400
inter-chromosomal merged intervals, including 11,600 (31.0\%) in the cited
22--95 bp short-conversion range and 927 (2.5\%) in the 318--688 bp
crossover-associated range; these proportions show compatibility with both
tract scales but do not assign event-level mechanism.
