...
How extensive subtelomeric sharing is across all arms, and whether recent
exchange leaves pedigree-resolved evidence, therefore remained unmeasured
genome-wide.
...
sequence similarity predict three-dimensional proximity in the nucleus; and does
recent exchange leave pedigree-resolved patch patterns within the same
communities.
...
\begin{figure}[h!]
  ...
  \caption{\textbf{Sequence similarity tracks three-dimensional proximity.}
    ...
    descriptive correlation across leptotene, zygotene, pachytene and diplotene.
