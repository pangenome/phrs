...
\begin{figure}[h!]
  ...
  \caption{\textbf{Whole-genome pedigree views of putative subtelomeric exchange.}
    ...
    track is the child query haplotype and the upper and lower tracks are the
    two parental haplotypes. Light-gray ribbons show same-chromosome homologous
    chains, while colored ribbons show runs where the best non-homologous
