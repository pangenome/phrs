...
We therefore interpret these as recombination-compatible PHR-exchange
candidates, not breakpoint-resolved or event-level truth calls.
Confirming individual WashU events will require orthogonal long-read
recombination maps \cite{Halldorsson2019,palsson2025recomb}.
...
\begin{figure}[h!]
  ...
  \caption{\textbf{Pedigree-resolved donor-recipient ribbons for candidate PHR exchange.}
    ...
    analysis (Xp/Yp C15, chr5q/chr1p C11, chr9q/chr3q C3).}
  \label{fig:fig5}
\end{figure}
