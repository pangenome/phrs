...
the adjacent flanks, which lack the homology used to define the pairs. A whole-genome comparison in
...
\begin{figure}[h!]
  ...
  \caption{\textbf{Genome-wide subtelomeric homology and PHR extent.}
    \textbf{(A)} Interchromosomal homology across 465 near-complete assemblies
