...
telomeres cluster at the nuclear envelope; in human data it persists even in
the adjacent flanks, which lack the shared sequence used to define the pairs. A whole-genome comparison in
