...
\begin{figure}[h!]
  ...
  \caption{\textbf{Genome-wide subtelomeric sharing and PHR extent.}
    ...
    \textbf{(B)} PHR length distribution across the terminal 500 kb, shown
    separately for p-arms and q-arms and coloured by the number of PHRs per 10 kb
    length bin (pseudo-log scale). Length is measured from the
    telomere (0 kb = telomere-proximal; q-arms flipped so both panels read
    telomere$\to$centromere). Non-acrocentric, non-PAR
