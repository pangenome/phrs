...
| `paper_prep/figures/ed4/figure_ed4.R` | ED4 generator. Includes a stale hard-coded prior-agent worktree `REPO_ROOT`. | Added by `88954d7`. | Do not reuse without path repair. |
