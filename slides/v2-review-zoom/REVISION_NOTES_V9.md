...
- proof PNGs: `slides/v2-review-zoom/_typst/page-01.png` through `page-53.png`
...
| `slide10m2_better_3d_viz/SLIDE_PATCH.md` | Slide 10m.2 now adds the same CHM13 PHR/subtelomeric Hi-C contact-space MDS as a 3D oblique view colored by sequence community. Slide 10m.3 follows with the clearer D1-D2 and D1-D3 projection view. Both captions state that these are bulk Hi-C contact-space MDS, not physical single-cell genome reconstructions. |
...
| `page-25.png` | 08b.1 | Nearest same-superpopulation MDS distance boxplot now includes KW, pairwise Wilcoxon, BH correction, stars, p-values, and brackets. v9.1 removes jittered points, sets the displayed y-axis to 0-1e-3, increases bracket spacing, and prints means. |
| `page-29.png` | 10m.2 | Added CHM13 PHR/subtelomeric contact-space MDS as a colored 3D oblique view. |
| `page-30.png` | 10m.3 | Keeps the clearer CHM13 PHR/subtelomeric contact-space MDS 2D projections and explicit non-physical-reconstruction caption. |
...
Slides 10m.2 and 10m.3 use the v9 contact-space replacement figures generated
from `chm13_hic.dist_matrix.tsv` and `chm13_subtelomeric_regions.bed`. Slide
10m.2 shows a single oblique 3D view; slide 10m.3 shows the clearer D1-D2 and
D1-D3 projections. Both figure captions distinguish bulk Hi-C contact-space MDS
from a physical single-cell 3DG reconstruction.
...
- Proof export produced 53 PNG pages at 1920 x 1080.
- All 53 proof PNG pages were decoded and checked for 1920 x 1080 geometry and
  ...
  `page-18.png`, `page-25.png`, `page-29.png`, and `page-30.png` all returned
  `OK`.
- Visual inspection covered the requested changed proof pages: 06a, 07j.a,
  07j.b, 07j.2, 07a.1b, 08b.1, 10m.2, and 10m.3.
