...
8. **3D genome organization mirrors sequence communities.**
   ...
   - *Key metrics*: Human Hi-C B/W 0.027–0.074 (8 datasets); RPE-1 HPRC B/W 0.005–0.052 (3 datasets, PHR coords); Dip-C T2T 6.9% closer (16 cells, Fisher p=2.4e-05, Mantel rho=0.30); Sperm W/B=0.401 (60% closer, 20 cells); Mouse Hi-C per-arm-pair rho=0.57–0.72, Mantel rho=0.58–0.72 (4 meiotic stages, 1Mb windows, per-haplotype, PHR coords); 2Mb: Mantel rho=0.61–0.70; 4Mb: Mantel rho=0.65–0.73. Negative control: 7 non-sharing arms 11% farther in GM12878, 40% farther in sperm. Community-free arm-level: Dip-C rho=0.34, human Hi-C rho=0.66–0.83.
   - *Conclusion*: Sequence similarity correlates with 3D proximity across all tested samples, cell types, and organisms. Comprehensive exclusion controls confirm this is NOT driven by acrocentric chromosomes, sex chromosomes, or the strongest communities — Mantel rho increases from 0.66 to 0.79 (HG002) when excluding all acrocentric + sex arms, and from 0.15 to 0.72 (HG02148). The signal is driven by ordinary autosomal communities.
