...
- **C2 / C3 dataset count.** Andrea reports 465 throughout; the abstract reports 466. Resolve canonically as 465 near-complete assemblies = 232 individuals × 2 haplotypes + CHM13 reference (per `CROSSWALK §7c`).
