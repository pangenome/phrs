...
- **Supports** draft P1/P2: "The Human Pangenome Reference Consortium v2 release delivers near-T2T haplotype-resolved assemblies for 233 individuals…" (main text) — the HGSVC3 paper is the companion SV analysis at 65 diverse genomes that demonstrates that combining HPRC v1 pangenome with T2T-quality assemblies enables detection of 26,115 SVs/individual at median QV 45 from short reads, a 2–3× increase over linear-reference calling. It directly extends the HGSVC2 (hprc_ebert2021) entry in the existing review's chronology.
