...
version: v3 (R2 audit fixes + REFERENCES_v5 round-2 citation upgrades)
abstract_words: 214
main_text_words: 4158
...
inputs:
  ...
  references: paper_prep/synthesis/REFERENCES_v5.bib (sha: 8f777fec749c096977de84e52f19b34affc9e304)
  citation_plan: paper_prep/synthesis/CITATION_UPGRADE_PLAN_v2.md
  lit_refresh: paper_prep/synthesis/LITERATURE_REFRESH_v2.md
  audit: paper_prep/synthesis/R2_AUDIT_PLAN.md
---
...
**Implicit pangenome graph and IMPG transitive closure.** The all-vs-all PAF set is the implicit pangenome graph; IMPG `query -x` computes reachability [@pangenome_graphs_impg_GarrisonGuarracino2023; @pangenome_graphs_impg_GuarracinoHeumos2022; @pangenome_graphs_impg_IMPG2023; @pangenome_graphs_impg_Hickey2024; @kaushan2026tracepoints]. Justification of "no chromosomal partitioning": realised sampling rate 11.6%, rounded to 12%, sits 230x above the Erdős and Rényi connectivity threshold p* = log(n)/n = 5.2 x 10^-4 for n = 18,827.
...
**Pangenome graph and Jaccard similarity.** `pggb -p 95 -D /scratch`; `odgi similarity --all -P` over the 15,668 sequences yields the 15,668 x 15,668 Jaccard matrix [@Garrison2024pggb; @Guarracino2023; @andreace2023pangenome; @heumos2024nfcore].
...
**UPGMA dendrogram.** `hclust(..., method = "average")` on the 41 x 41 distance matrix; k = 14 (mean silhouette 0.342); agreement with Leiden 12 of 15.
...
**Single-cell 3D.** Dip-C in 16 GM12878 cells [@Tan2018] (17 raw cells; cell 12 excluded as a duplicate of cell 10) remapped to T2T-CHM13v2.0; sperm scHi-C in 20 cells [@Xu2025; @hic3d_scnanoHiC2023; @hic3d_scnanoHiC2_2025; @hic3d_kitamura2025]. PBMC Dip-C negative control: 18 cells with PHR coordinates projected from CHM13 to hg19 via impg, yielding W/B = 0.983, p = 0.305 (`05_hic_validation.md` §PBMC, L455-469). Negative control S_all: pooled 7 zero-signal arms (chr2_p, chr3_p, chr5_p, chr8_q, chr11_q, chr14_q, chr18_q).
...
**Pedigree odgi-untangle.** `odgi untangle nth-best=1` per flank; high-quality filter: min_score >= 0.8 with 500 bp <= size <= 100 kb; within-Leiden filter applied as credibility constraint; pattern classification (gene_conversion_like, crossover_like, acros_like, sandwich_same_hap, complex) via `scripts/pedigree/analyze-pedigree-recombination.py` [@Cechova2025; @Porubsky2025]. Patch tract-length distributions are interpreted in the framework of long-read primate meiotic recombination, in which NCO tracts average 22 to 95 bp and CO-associated tracts average 318 to 688 bp [@pedigree_Porsborg2025primaterecom].
...
acrocentric_rdna_robertsonian_hartley2026biobank
Ambrosini2007
andreace2023pangenome
ataei2025line1dj
Bailey2002
BaileyEichler2006
Bergstrom2020
...
bouquet_ChenCEP164Cilia2025
bouquet_GarnerKASH52023
...
pangenome_Loegler2025review
Patel2019
pedigree_Joseph2024PRDM9indep
pedigree_Porsborg2025primaterecom
pedigree_Schweiger2024spermNCO
Porubsky2025
porubsky2026chr22q11
Riethman2001
Riethman2004
Riethman2008
Rouyer1986
