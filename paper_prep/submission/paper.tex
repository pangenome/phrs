...
\abstract{
Human subtelomeres are among the most dynamic regions of the genome, yet their relationships across chromosomes have been hard to chart, limited by incomplete assemblies and by alignment that partitions sequence chromosome by chromosome. Using 466 near-complete haplotype assemblies from the second Human Pangenome Reference Consortium release, we map these relationships without such partitioning, through an implicit pangenome graph: a reference-free, all-to-all alignment that samples about 12\% of haplotype pairs and is queried directly, without ever building the graph. We find extended interchromosomal homology at nearly all subtelomeres, spanning tens to hundreds of kilobases, comparable in scale to the pseudoautosomal region PAR2 and totalling 3.5 Mb outside the acrocentrics and sex chromosomes. These pseudo-homolog regions partition into communities that recover every known case of subtelomeric homology (the pseudoautosomal pairs, the acrocentric short arms, 10p/18p and the 4q/10q DUX4 system) and uncover new ones, including a tightly linked clade of six q-arms. Across human and mouse three-dimensional genome maps, arms sharing a community contact one another more often; in mouse, where germline-stage data exist, this peaks at the meiotic bouquet. In a telomere-to-telomere human pedigree we directly observe inter-chromosomal exchange within these communities. Subtelomeric pseudo-homolog regions are thus a near-ubiquitous feature of human chromosomes, maintained by ongoing recombination organized by the three-dimensional architecture of meiosis, and resolved here at population scale in complete genomes for the first time.
}
...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.49\linewidth]{fig/MainFigures/Fig2b_tree_jaccard.pdf}\hfill
  \includegraphics[width=0.49\linewidth]{fig/MainFigures/Fig2c_community_jaccard.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{fig/MainFigures/Fig4a_human_scatter.pdf}\\[4pt]
  \includegraphics[width=0.6\linewidth]{fig/MainFigures/Fig4b_porec_community.pdf}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=\linewidth]{fig/ExtendedDataFigures/ED_Fig1_mouse_zygotene.pdf}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=\linewidth]{fig/ExtendedDataFigures/ED_Fig2_allpoints.pdf}
  \caption{\textbf{Per-PHR-pair sequence similarity versus three-dimensional
    ...
    pair of pseudo-homolog regions (PHRs) within a single genome, so both axes
