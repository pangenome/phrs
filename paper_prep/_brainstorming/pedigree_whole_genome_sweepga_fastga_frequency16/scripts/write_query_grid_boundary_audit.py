...
def main():
    ...
    for line in proc.stdout.splitlines():
        ...
        rows.append({
            "comparison_id": "shifted_same_query",
            "query_name": f[0],
            "target_name": f[5],
            "target_start": f[7],
            "chunk_q_start": f[2],
            ...
            "provenance": "synthetic shifted raw mappings row_a 7-27 and row_b 12-32 on qA; both are cut at absolute qA grid boundary 20",
        })
