...
#SBATCH --output=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_mappingfiltered_impg_similarity_2kb_topn_depthcapped_10to10/logs/wfmash_p95_updated_bin.PAN027pat_vs_PAN011_joint.topn_depthcapped.array.slurm.%a.%A.out
#SBATCH --error=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_mappingfiltered_impg_similarity_2kb_topn_depthcapped_10to10/logs/wfmash_p95_updated_bin.PAN027pat_vs_PAN011_joint.topn_depthcapped.array.slurm.%a.%A.err
set -euo pipefail
export LC_ALL=C
task_manifest=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_mappingfiltered_impg_similarity_2kb_topn_depthcapped_10to10/manifests/array_tasks/wfmash_p95_updated_bin.PAN027pat_vs_PAN011_joint.tasks.tsv
