# Fig5 Raw 2 kb IMPG Similarity, Plane-Sweep 10:10
...
mapping filtering with `--num-mappings 10:10` before local similarity.
...
- `impg similarity` uses `--no-merge --num-mappings 10:10 --scaffold-jump 0`.
