...
LENGTHS = [int(x) for x in os.environ.get("QUERY_GRID_CHOP_LENGTHS", "10000 5000 2000").split()]
FASTGA_FREQUENCY = "32"
...
def main():
    ...
    for cid in comparisons:
        for length in LENGTHS:
            ...
            manifest_status = "OK" if chopped_ok and filtered_ok and worker_status == "OK" else "MISSING_OR_INVALID"
    ...
    manifest_fields = [
        "comparison_id", "fastga_frequency", "chop_length_bp", "filter_id", "chunk_mode", "output_family",
