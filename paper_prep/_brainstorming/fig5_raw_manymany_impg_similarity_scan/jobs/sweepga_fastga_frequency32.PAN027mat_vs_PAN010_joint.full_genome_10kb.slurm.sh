#!/usr/bin/env bash
#SBATCH --job-name=impg_sweepg_PAN027mat_vs_P
#SBATCH --partition=workers
#SBATCH --cpus-per-task=48
#SBATCH --nodes=1
#SBATCH --time=24:00:00
#SBATCH --output=/moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/logs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.full_genome_10kb.%j.out
#SBATCH --error=/moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/logs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.full_genome_10kb.%j.err
set -euo pipefail
export LC_ALL=C
...
tmp_tsv=/moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/outputs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.full_genome_10kb.impg_similarity.tsv
out_gz=/moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/outputs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.full_genome_10kb.impg_similarity.tsv.gz
metadata=/moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/outputs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.full_genome_10kb.metadata.json
command_text='/home/erikg/.cargo/bin/impg similarity --alignment-files /moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/bgzf_raw_paf/PAN027mat_vs_PAN010_joint.sweepga_frequency32_many_many_j0.bgzf.paf.gz --target-bed /moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/beds/PAN027mat_vs_PAN010_joint.full_genome_10kb.bed --sequence-files /moosefs/erikg/phrs/.wg-worktrees/agent-2636/paper_prep/_brainstorming/pedigree_whole_genome_wfmash_p95_updated_bin/inputs/PAN027mat_vs_PAN010_joint.query.fa /moosefs/erikg/phrs/.wg-worktrees/agent-2636/paper_prep/_brainstorming/pedigree_whole_genome_wfmash_p95_updated_bin/inputs/PAN027mat_vs_PAN010_joint.target.fa --gfa-engine poa --no-merge --num-mappings many:many --scaffold-jump 0 --threads ${SLURM_CPUS_PER_TASK}'
...
cat > "$metadata" <<JSON
{
  ...
  "output_tsv_gz": "/moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/outputs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.full_genome_10kb.impg_similarity.tsv.gz",
...
JSON
echo "$command_text"
/home/erikg/.cargo/bin/impg similarity --alignment-files /moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/bgzf_raw_paf/PAN027mat_vs_PAN010_joint.sweepga_frequency32_many_many_j0.bgzf.paf.gz --target-bed /moosefs/erikg/phrs/.wg-worktrees/agent-2762/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_scan/beds/PAN027mat_vs_PAN010_joint.full_genome_10kb.bed --sequence-files /moosefs/erikg/phrs/.wg-worktrees/agent-2636/paper_prep/_brainstorming/pedigree_whole_genome_wfmash_p95_updated_bin/inputs/PAN027mat_vs_PAN010_joint.query.fa /moosefs/erikg/phrs/.wg-worktrees/agent-2636/paper_prep/_brainstorming/pedigree_whole_genome_wfmash_p95_updated_bin/inputs/PAN027mat_vs_PAN010_joint.target.fa --gfa-engine poa --no-merge --num-mappings many:many --scaffold-jump 0 --threads ${SLURM_CPUS_PER_TASK} > "$tmp_tsv"
gzip -f "$tmp_tsv"
