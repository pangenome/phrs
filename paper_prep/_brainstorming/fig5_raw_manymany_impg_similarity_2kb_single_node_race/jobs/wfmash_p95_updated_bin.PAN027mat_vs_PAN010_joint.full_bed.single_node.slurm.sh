#!/usr/bin/env bash
#SBATCH --job-name=fig5_1node_wfmash_PAN027mat_vs_P
#SBATCH --partition=tux
#SBATCH --cpus-per-task=96
#SBATCH --nodes=1
#SBATCH --time=7-00:00:00
#SBATCH --output=/moosefs/erikg/phrs/.wg-worktrees/agent-2859/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_single_node_race/logs/wfmash_p95_updated_bin.PAN027mat_vs_PAN010_joint.%j.out
#SBATCH --error=/moosefs/erikg/phrs/.wg-worktrees/agent-2859/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_single_node_race/logs/wfmash_p95_updated_bin.PAN027mat_vs_PAN010_joint.%j.err
set -euo pipefail
export LC_ALL=C
...
output_tsv_gz=/moosefs/erikg/phrs/.wg-worktrees/agent-2859/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_single_node_race/outputs/all_hits/wfmash_p95_updated_bin/wfmash_p95_updated_bin.PAN027mat_vs_PAN010_joint.full_genome_2kb.impg_similarity.tsv.gz
metadata_json=/moosefs/erikg/phrs/.wg-worktrees/agent-2859/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_single_node_race/metadata/jobs/wfmash_p95_updated_bin/wfmash_p95_updated_bin.PAN027mat_vs_PAN010_joint.full_genome_2kb.metadata.json
