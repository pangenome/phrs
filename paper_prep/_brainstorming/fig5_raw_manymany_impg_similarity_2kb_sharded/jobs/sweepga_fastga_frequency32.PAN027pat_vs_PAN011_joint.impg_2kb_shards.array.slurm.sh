#!/usr/bin/env bash
#SBATCH --job-name=fig5_impg_sweepg_PAN027pat_vs_P
#SBATCH --partition=workers
#SBATCH --cpus-per-task=48
#SBATCH --nodes=1
#SBATCH --time=24:00:00
#SBATCH --array=0-148%6
#SBATCH --output=/moosefs/erikg/phrs/.wg-worktrees/agent-2837/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_sharded/logs/sweepga_fastga_frequency32.PAN027pat_vs_PAN011_joint.shard_%a.%A.out
#SBATCH --error=/moosefs/erikg/phrs/.wg-worktrees/agent-2837/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_sharded/logs/sweepga_fastga_frequency32.PAN027pat_vs_PAN011_joint.shard_%a.%A.err
set -euo pipefail
export LC_ALL=C
task_manifest=/moosefs/erikg/phrs/.wg-worktrees/agent-2837/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_sharded/manifests/array_tasks/sweepga_fastga_frequency32.PAN027pat_vs_PAN011_joint.tasks.tsv
