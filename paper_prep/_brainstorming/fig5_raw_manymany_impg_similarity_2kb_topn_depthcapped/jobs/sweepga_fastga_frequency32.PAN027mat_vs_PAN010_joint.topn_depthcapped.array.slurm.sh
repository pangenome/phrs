...
#SBATCH --output=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/logs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.topn_depthcapped.array.slurm.%a.%A.out
#SBATCH --error=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/logs/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.topn_depthcapped.array.slurm.%a.%A.err
set -euo pipefail
export LC_ALL=C
task_manifest=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/manifests/array_tasks/sweepga_fastga_frequency32.PAN027mat_vs_PAN010_joint.tasks.tsv
