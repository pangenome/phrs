...
#SBATCH --array=0-148%6
#SBATCH --output=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/logs/wfmash_p95_updated_bin.PAN027pat_vs_PAN011_joint.topn_depthcapped.array.slurm.%a.%A.out
#SBATCH --error=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/logs/wfmash_p95_updated_bin.PAN027pat_vs_PAN011_joint.topn_depthcapped.array.slurm.%a.%A.err
set -euo pipefail
export LC_ALL=C
task_manifest=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/manifests/array_tasks/wfmash_p95_updated_bin.PAN027pat_vs_PAN011_joint.tasks.tsv
impg=/home/erikg/.cargo/bin/impg
filter=/moosefs/erikg/phrs/paper_prep/_brainstorming/fig5_raw_manymany_impg_similarity_2kb_topn_depthcapped/scripts/filter_impg_similarity_topn.py
pigz=/usr/bin/pigz
