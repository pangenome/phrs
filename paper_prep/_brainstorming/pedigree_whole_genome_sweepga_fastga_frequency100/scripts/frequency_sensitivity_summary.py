...
def main():
    ...
    for candidate_id in sorted(by_candidate):
        ...
        freq100_chr3 = yes_no(cur, "target_chrom", "chr3", "emits_chr3_target")
        prior_chr3 = yes_no(prior, "target_chrom", "chr3", "emits_chr3_target")
        wfmash_chr3 = yes_no(wf, "target_chrom", "chr3", "chr3_support")
        rows.append({
            **by_candidate[candidate_id],
            "explicit_fastga_frequency100_raw_chr3": freq100_chr3,
            "prior_updated_bin_raw_no_explicit_frequency_chr3": prior_chr3,
            "updated_wfmash_p95_chr3": wfmash_chr3,
            "frequency100_rescues_chr3_vs_prior": "yes" if freq100_chr3 == "yes" and prior_chr3 == "no" else "no",
            "wfmash_positive_sweepga_frequency100_negative": "yes" if wfmash_chr3 == "yes" and freq100_chr3 == "no" else "no",
        })
    ...
    write_tsv(
        ...
        [
            ...
            "query_start",
            "query_end",
            "explicit_fastga_frequency100_raw_chr3",
            "prior_updated_bin_raw_no_explicit_frequency_chr3",
            "updated_wfmash_p95_chr3",
            "frequency100_rescues_chr3_vs_prior",
            "wfmash_positive_sweepga_frequency100_negative",
        ],
    )
